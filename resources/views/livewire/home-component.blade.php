...
<section id="slider-part" class="slider-active">
    <div class="single-slider bg_cover pt-150" style="background-image: url(asset/images/slider/slider0.jpg)" data-overlay="4">
        <div class="container">
            <div class="row">
                <div class="col-xl-7 col-lg-9">
                    <div class="slider-cont">
                        <h1 data-animation="bounceInLeft" data-delay="1s">Learning With SELFTEACH-LAB.</br>Here All Course is Available.</br>Stay With SelfTeach-Lab.</h1>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="category-text pt-40">
                        <h2>Self_Teach_Lab is best platform to learn everything</h2>
                    </div>
                </div>
                        ...
                        <div class="col-lg-4">
                            <a href="#">
                                <span class="singel-category text-center color-2">
                                    <span class="icon">
                                        <img src="asset/images/all-icon/quiz.png" alt="Icon" style="Height:80px;">
                                    </span>
                                    <span class="cont">
                                        <span>Play Quiz</span>
                                    </span>
    ...
    <div class="container">
        ...
        <div class="row course-slied mt-30">
            ...
            <div class="card">
                ...
                <div class="image">
                    <img src="asset/images/card/card-3.jpg">
                </div>
                <div class="title">
                    <h1> Free Quiz</h1>
            ...
            <div class="card">
                ...
                <div class="image">
                    <img src="asset/images/card/card-4.jpg">
                </div>
                <div class="title">
                    <h1> Free Quiz</h1>
