    ...
    <form method="POST" action="{{ route('admin.saveUser') }}" id="userForm">
        ...
        <div class="form-group col-md-4">
          ...
          <input type="text" class="form-control" name="Name" 
            ...
            @if ($errors->has('first_name'))
                <label class="error" for="first_name">{{ $errors->first('name') }}</label>
            @endif
        </div>
      ...
      <div class="form-group col-md-4">
          ...
          <div>
              ...
              <div class="checkbox-custom checkbox-default checkbox-inline">
                <input type="checkbox" id="inputCheckboxquizmaster" name="roles[]" value="quizmaster" @if($user->id &&  $user->hasRole('quizmaster')) checked @endif>
                <label for="inputCheckboxInstructor">QuizMaster</label>
              </div>
