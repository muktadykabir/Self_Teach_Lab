                                ...
                                @auth 
                                    @if(Auth::user()->utype ==='ADM')
                                        <li class="menu-item menu-item-has-children parent">
                                            <div class="btn-group">
                                                {{-- <div class="dropdown"> --}}
                                                {{-- <a title="My Account" class="btn btn-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                                                    My Account({{Auth::user()->name}})<i class="fa fa-angle-down" aria-hidden="true"></i>
                                                </a> --}}
                                ...
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        {{-- <ul class="sub-menu">
                                            ...
                                            <li><a href="courses.php">CourseList</a></li>
                                            <li class="nav-item"><a href="">Catagories</a>
