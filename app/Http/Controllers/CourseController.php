...
class CourseController extends Controller
{
    ...
    public function myCourses(Request $request)
    {
        ...
        return view('site.course.my-courses', compact('courses','users'));
    }
    ...
    public function courseRate(Request $request)
    {
        ...
        if($rating_id) {
            $rating = course_ratings::find($rating_id);
            $success_message = 'Your review have been updated successfully';
        } else {
            $rating = new course_ratings();
    ...
    {
        course_ratings::where('id', $rating_id)->delete();
    ...
    {   
        ...
        $course_rating = course_ratings::where('course_id', $course->id)->where('user_id', \Auth::user()->id)->first();
        if(!$course_rating) {
    ...
    public function courseList($course_slug = '', Request $request)
    {
        ...
        $instruction_levels = instruction_levels::get();
    ...
    public function instructorCourseVideoSave(Request $request)
    {
        ...
        $courseVideos = new course_videos;
    ...
    public function postLectureResourceSave($lid,Request $request)
    {
            ...
            if($courseFiles->save()){
                ...
                $return_data = array(
                    ...
                    'file_title'=> $file_title,
                    'file_size'=> \SelfteachHelpers::HumanFileSize($file_size)
                );
            }else{
                $return_data = array(
                    'status'=>false,
